export default function MongoDbIcon({ className = "h-8 w-8" }) {
  return (
    <svg
      viewBox="0 0 32 32"
    ...
    >
      ...
      <path
        d="M15.487 26.569S9.366 22.4 9.72 15.025A15.54 15.54 0 0 1 15.239 3.377 1.725 1.725 0 0 0 15.846 2c.381.82.319 12.243.359 13.579.155 5.197-.289 10.009-.718 10.99z"
        fill="url(#mongo_c)"
      />
    </svg>
  );
